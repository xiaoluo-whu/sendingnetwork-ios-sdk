...
public enum MXRoomCapabilityStringType: String {
    /// knocking join rule support [MSC2403](https://github.com/sending-network/sendingnetwork-doc/pull/2403)
    case knock = "knock"
    /// restricted join rule support [MSC3083](https://github.com/sending-network/sendingnetwork-doc/pull/3083)
