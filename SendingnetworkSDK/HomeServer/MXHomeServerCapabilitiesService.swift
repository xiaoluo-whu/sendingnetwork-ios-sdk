...
///  Used to know current homeserver capabilities as per [sending.network specifications](https://sending.network/docs/spec/client_server/r0.6.1#get-sendingnetwork-client-r0-capabilities)
///  and [MSC3244](https://github.com/sending-network/sendingnetwork-doc/pull/3244)
@objcMembers
public class MXHomeserverCapabilitiesService: NSObject {
    ...
    public func update(completion: (() -> Void)? = nil) {
        ...
        self.currentRequest = session.sendingnetworkRestClient.homeServerCapabilities { [weak self] response in
