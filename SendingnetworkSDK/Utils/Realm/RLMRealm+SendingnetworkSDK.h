...
@interface RLMRealm (SendingnetworkSDK)

/**
 Same method with `RLMRealm(SendingnetworkSDK) transactionWithName:block:error` without error handling.
 @see -[RLMRealm(SendingnetworkSDK) transactionWithName:block:error]
 */
