...
FOUNDATION_EXPORT NSString *const kMXToolsRegexStringForSendingnetworkUserIdentifier;
FOUNDATION_EXPORT NSString *const kMXToolsRegexStringForSendingnetworkRoomAlias;
FOUNDATION_EXPORT NSString *const kMXToolsRegexStringForSendingnetworkRoomIdentifier;
FOUNDATION_EXPORT NSString *const kMXToolsRegexStringForSendingnetworkEventIdentifier;
FOUNDATION_EXPORT NSString *const kMXToolsRegexStringForSendingnetworkGroupIdentifier;
...
/**
 Check whether a string is formatted as a sendingnetwork user identifier.
 
 @return YES if the provided string is formatted as a sendingnetwork user id.
 */
+ (BOOL)isSendingnetworkUserIdentifier:(NSString *)inputString;

/**
 Check whether a string is formatted as a sendingnetwork room alias.
 
 @return YES if the provided string is formatted as a sendingnetwork room alias.
 */
+ (BOOL)isSendingnetworkRoomAlias:(NSString *)inputString;

/**
 Check whether a string is formatted as a sendingnetwork room identifier.
 
 @return YES if the provided string is formatted as a sendingnetwork room identifier.
 */
+ (BOOL)isSendingnetworkRoomIdentifier:(NSString *)inputString;

/**
 Check whether a string is formatted as a sendingnetwork event identifier.

 @return YES if the provided string is formatted as a sendingnetwork event identifier.
 */
+ (BOOL)isSendingnetworkEventIdentifier:(NSString *)inputString;

/**
 Check whether a string is formatted as a sendingnetwork group identifier.
 
 @return YES if the provided string is formatted as a sendingnetwork group identifier.
 */
+ (BOOL)isSendingnetworkGroupIdentifier:(NSString *)inputString;

/**
 Extract the server name part of a sendingnetwork identifier.

 For example, this methods returns "sending.network" from "!anEvent:sending.network"

 @param identifier a Sendingnetwork identifier.
...
/*
 ...
 The permalink could be sendingnetwork.to format or a custom client permalink (see `MXSDKOptions.clientPermalinkBaseUrl`).
