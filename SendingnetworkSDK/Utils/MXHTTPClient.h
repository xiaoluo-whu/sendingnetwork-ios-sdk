...
/**
 Posted when a Sendingnetwork error is observed.
 The `userInfo` dictionary contains an `MXError` object under the `kMXHTTPClientSendingnetworkErrorNotificationErrorKey` key
 */
FOUNDATION_EXPORT NSString* const kMXHTTPClientSendingnetworkErrorNotification;
FOUNDATION_EXPORT NSString* const kMXHTTPClientSendingnetworkErrorNotificationErrorKey;
...
/**
 ...
 The time is based on an exponential backoff plus a jitter in order to prevent all Sendingnetwork clients
