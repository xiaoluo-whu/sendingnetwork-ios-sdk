...
/**
 ...
 Bug reports are sent to the bugreport API (https://github.com/sending-network/rageshake).
 It purposefully does not use Sendingnetwork as bug reports may be made when Sendingnetwork is
