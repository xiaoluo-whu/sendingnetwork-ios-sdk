...
// The HS domain part in Sendingnetwork identifiers
#define SENDINGNETWORK_HOMESERVER_DOMAIN_REGEX                            @"[A-Z0-9]+((\\.|\\-)[A-Z0-9]+){0,}(:[0-9]{2,5})?"

NSString *const kMXToolsRegexStringForSendingnetworkUserIdentifier      = @"@[\\x21-\\x39\\x3B-\\x7F]+:" SENDINGNETWORK_HOMESERVER_DOMAIN_REGEX;
NSString *const kMXToolsRegexStringForSendingnetworkRoomAlias           = @"#[A-Z0-9._%#@=+-]+:" SENDINGNETWORK_HOMESERVER_DOMAIN_REGEX;
NSString *const kMXToolsRegexStringForSendingnetworkRoomIdentifier      = @"![A-Z0-9]+:" SENDINGNETWORK_HOMESERVER_DOMAIN_REGEX;
NSString *const kMXToolsRegexStringForSendingnetworkEventIdentifier     = @"\\$[A-Z0-9]+:" SENDINGNETWORK_HOMESERVER_DOMAIN_REGEX;
NSString *const kMXToolsRegexStringForSendingnetworkEventIdentifierV3   = @"\\$[A-Z0-9\\/+]+";
NSString *const kMXToolsRegexStringForSendingnetworkGroupIdentifier     = @"\\+[A-Z0-9=_\\-./]+:" SENDINGNETWORK_HOMESERVER_DOMAIN_REGEX;
...
static NSRegularExpression *isSendingnetworkUserIdentifierRegex;
static NSRegularExpression *isSendingnetworkRoomAliasRegex;
static NSRegularExpression *isSendingnetworkRoomIdentifierRegex;
static NSRegularExpression *isSendingnetworkEventIdentifierRegex;
static NSRegularExpression *isSendingnetworkEventIdentifierV3Regex;
static NSRegularExpression *isSendingnetworkGroupIdentifierRegex;
...
+ (void)initialize
{
    ...
    dispatch_once(&onceToken, ^{
        ...
        isSendingnetworkUserIdentifierRegex = [NSRegularExpression regularExpressionWithPattern:[NSString stringWithFormat:@"^%@$", kMXToolsRegexStringForSendingnetworkUserIdentifier]
                                                                                options:NSRegularExpressionCaseInsensitive error:nil];
        isSendingnetworkRoomAliasRegex = [NSRegularExpression regularExpressionWithPattern:[NSString stringWithFormat:@"^%@$", kMXToolsRegexStringForSendingnetworkRoomAlias]
                                                                           options:NSRegularExpressionCaseInsensitive error:nil];
        isSendingnetworkRoomIdentifierRegex = [NSRegularExpression regularExpressionWithPattern:[NSString stringWithFormat:@"^%@$", kMXToolsRegexStringForSendingnetworkRoomIdentifier]
                                                                                options:NSRegularExpressionCaseInsensitive error:nil];
        isSendingnetworkEventIdentifierRegex = [NSRegularExpression regularExpressionWithPattern:[NSString stringWithFormat:@"^%@$", kMXToolsRegexStringForSendingnetworkEventIdentifier]
                                                                                 options:NSRegularExpressionCaseInsensitive error:nil];
        isSendingnetworkEventIdentifierV3Regex = [NSRegularExpression regularExpressionWithPattern:[NSString stringWithFormat:@"^%@$", kMXToolsRegexStringForSendingnetworkEventIdentifierV3]
                                                                                 options:NSRegularExpressionCaseInsensitive error:nil];

        isSendingnetworkGroupIdentifierRegex = [NSRegularExpression regularExpressionWithPattern:[NSString stringWithFormat:@"^%@$", kMXToolsRegexStringForSendingnetworkGroupIdentifier]
                                                                                options:NSRegularExpressionCaseInsensitive error:nil];
...
+ (BOOL)isSendingnetworkUserIdentifier:(NSString *)inputString
{
    if (inputString)
    {
        return (nil != [isSendingnetworkUserIdentifierRegex firstMatchInString:inputString options:0 range:NSMakeRange(0, inputString.length)]);
    }
    return NO;
}

+ (BOOL)isSendingnetworkRoomAlias:(NSString *)inputString
{
    if (inputString)
    {
        return (nil != [isSendingnetworkRoomAliasRegex firstMatchInString:inputString options:0 range:NSMakeRange(0, inputString.length)]);
    }
    return NO;
}

+ (BOOL)isSendingnetworkRoomIdentifier:(NSString *)inputString
{
    if (inputString)
    {
        return (nil != [isSendingnetworkRoomIdentifierRegex firstMatchInString:inputString options:0 range:NSMakeRange(0, inputString.length)]);
    }
    return NO;
}

+ (BOOL)isSendingnetworkEventIdentifier:(NSString *)inputString
{
    if (inputString)
    {
        return (nil != [isSendingnetworkEventIdentifierRegex firstMatchInString:inputString options:0 range:NSMakeRange(0, inputString.length)])
        || (nil != [isSendingnetworkEventIdentifierV3Regex firstMatchInString:inputString options:0 range:NSMakeRange(0, inputString.length)]);
    }
    return NO;
}

+ (BOOL)isSendingnetworkGroupIdentifier:(NSString *)inputString
{
    if (inputString)
    {
        return (nil != [isSendingnetworkGroupIdentifierRegex firstMatchInString:inputString options:0 range:NSMakeRange(0, inputString.length)]);
    }
    return NO;
}

+ (NSString*)serverNameInSendingnetworkIdentifier:(NSString *)identifier
{
...
+ (NSString *)permalinkToRoom:(NSString *)roomIdOrAlias
{
    ...
    NSString *baseUrl = clientBaseUrl != nil ? clientBaseUrl : kMXSendingnetworkDotToUrl;
