...
/**
 ...
 Media upload is based on sendingnetwork content repository. It requires a sendingnetwork session.
 */
@interface MXMediaManager : NSObject

/**
 Create an instance based on a homeserver url. This homeserver URL is required to resolve
 the Sendingnetwork Content URI (in the form of "mxc://...").
...
/**
 Resolve a Sendingnetwork media content URI (in the form of "mxc://...") into an HTTP URL.
 
 @param mxcContentURI the Sendingnetwork content URI to resolve.
 @return the Sendingnetwork content HTTP URL. nil if the Sendingnetwork content URI is invalid.
 */
- (NSString*)urlOfContent:(NSString*)mxcContentURI;

/**
 Get the suitable HTTP URL of a thumbnail image from a Sendingnetwork media content according to the destined view size.

 @param mxcContentURI the Sendingnetwork content URI to resolve.
 @param viewSize in points, it will be converted in pixels by considering screen scale.
 @param thumbnailingMethod the method the Sendingnetwork content repository must use to generate the thumbnail.
 @return the thumbnail HTTP URL. The provided URI is returned if it is not a valid Sendingnetwork content URI.
 */
...
/**
 Get the unique download identifier for a Sendingnetwork Content URI, consider a potential cache folder to handle
 several downloads in different cache areas.
 
 @param mxContentURI the Sendingnetwork Content URI (mxc://...).
 @param folder cache folder to use (may be nil). kMXMediaManagerDefaultCacheFolder is used by default.
 @return the download identifier. nil if the Sendingnetwork Content URI is invalid.
 */
+ (NSString*)downloadIdForSendingnetworkContentURI:(NSString*)mxContentURI
                                  inFolder:(NSString*)folder;

/**
 Get the unique download identifier for a thumbnail downloaded from on the Sendingnetwork Content URI,
...
/**
 Download data from the provided Sendingnetwork Content (MXC) URI (in the form of "mxc://...").
 
 @param mxContentURI the Sendingnetwork Content URI.
...
/**
 Download thumbnail data from the provided Sendingnetwork Content (MXC) URI (in the form of "mxc://...")
...
/**
 Download encrypted data from the Sendingnetwork Content repository.
 
 @param encryptedContentFile the encrypted Sendingnetwork Content details.
...
/**
 Prepares a media loader to upload data to a sendingnetwork content repository.
 ...
 @param mxSession the sendingnetwork session used to upload media.
...
/**
 Build a cache file path based on the Sendingnetwork Content URI of the media and an optional cache folder.
 ...
 @param mimeType the media mime type (may be nil).
 @param folder cache folder to use (may be nil). kMXMediaManagerDefaultCacheFolder is used by default.
 @return cache file path. nil if the Sendingnetwork Content URI is invalid.
 */
+ (NSString*)cachePathForSendingnetworkContentURI:(NSString*)mxContentURI
                                  andType:(NSString *)mimeType
                                 inFolder:(NSString*)folder;

/**
 Build a cache file path for a thumbnail downloaded from on the Sendingnetwork Content URI.
