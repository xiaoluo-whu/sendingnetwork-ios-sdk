...
public class MXCryptoV2: MXCrypto {
    ...
    public override class func createCrypto(withSendingnetworkSession mxSession: MXSession!) -> MXCrypto! {
        warnNotImplemented()
        return nil
    }
    
    public override class func check(withSendingnetworkSession mxSession: MXSession!, complete: ((MXCrypto?) -> Void)!) {
        warnNotImplemented()
    }
