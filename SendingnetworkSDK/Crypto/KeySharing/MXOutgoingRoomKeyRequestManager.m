...
{
    MXRestClient *sendingnetworkRestClient;
    NSString *deviceId;
                     ...
                     failure:(void (^)(NSError *error))failure
{
    ...
    [sendingnetworkRestClient sendToDevice:kMXEventTypeStringRoomKeyRequest contentMap:contentMap txnId:txnId success:success failure:failure];
}
