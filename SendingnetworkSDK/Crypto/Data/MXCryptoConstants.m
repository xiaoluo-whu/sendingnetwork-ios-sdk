...
NSString *const MXCryptoOlmPickleKeyDataType    = @"org.sendingnetwork.sdk.olm.pickle.key";


#pragma mark - Encrypting error

NSString *const MXEncryptingErrorDomain = @"org.sendingnetwork.sdk.encryption";
