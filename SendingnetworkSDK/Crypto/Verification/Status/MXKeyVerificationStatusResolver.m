...
- (instancetype)initWithManager:(MXKeyVerificationManager*)manager sendingnetworkSession:(MXSession*)sendingnetworkSession;

{
    ...
    if (self)
    {
        ...
        self.mxSession = sendingnetworkSession;
    }
    return self;
}
