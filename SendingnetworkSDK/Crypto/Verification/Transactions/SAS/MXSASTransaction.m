                                  ...
                                  otherDevice:(MXDeviceInfo*)otherDevice otherSasPublicKey:(NSString*)otherSasPublicKey
{
    ...
    if ([_accepted.keyAgreementProtocol isEqualToString:MXSASAgreementProtocols.v1])
    {
        ...
        // - the string “SENDINGNETWORK_KEY_VERIFICATION_SAS”,
        // - the Sendingnetwork ID of the user who sent the m.key.verification.start message,
        // - the device ID of the device that sent the m.key.verification.start message,
        // - the Sendingnetwork ID of the user who sent the m.key.verification.accept message,
        // - he device ID of the device that sent the m.key.verification.accept message
        // - the transaction ID.
        sasInfo = [NSString stringWithFormat:@"SENDINGNETWORK_KEY_VERIFICATION_SAS%@%@%@%@%@",
...
- (MXKeyVerificationMac*)macContentWithDevice:(MXDeviceInfo*)device andOtherDevice:(MXDeviceInfo*)otherDevice
{
    ...
    //  - the string “SENDINGNETWORK_KEY_VERIFICATION_MAC”,
    //  - the Sendingnetwork ID of the user whose key is being MAC-ed,
    //  - the device ID of the device sending the MAC,
    //  - the Sendingnetwork ID of the other user,
...
{
    return [NSString stringWithFormat:@"SENDINGNETWORK_KEY_VERIFICATION_MAC%@%@%@%@%@",
