...
NSString *const MXSecretStorageErrorDomain = @"org.sendingnetwork.sdk.MXSecretStorage";
...
- (instancetype)initWithSendingnetworkSession:(MXSession *)mxSession processingQueue:(dispatch_queue_t)aProcessingQueue
{
    self = [super init];
    if (self)
    {
...
{
    // MSC2472(https://github.com/uhoreg/sendingnetwork-doc/blob/symmetric_ssss/proposals/2472-symmetric-ssss.md) says:
