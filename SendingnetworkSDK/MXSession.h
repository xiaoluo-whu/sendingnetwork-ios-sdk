...
typedef NS_ENUM(NSUInteger, MXSessionState)
{
    ...
    /**
     ...
     @discussion
     The Sendingnetwork session will automatically establish it again. Once back, the state will move to
     MXSessionStateRunning.
     */
    ...
    /**
     ...
     @discussion
     The Sendingnetwork session will automatically go back MXSessionStateRunning once possible.
     */
    ...
    /**
     ...
     @discussion
     The Sendingnetwork session will stay in this state until a new call of [MXSession start:failure:].
     */
...
/**
 Posted when the sendingnetwork account data are updated from homeserver.
...
/**
 Posted when MXSession has updated the publicised groups of some sendingnetwork users.
...
/**
 The key in notification userInfo dictionary representating the sendingnetwork homeserver
...
/**
 The sendingnetwork REST Client used to make Sendingnetwork API requests.
 */
@property (nonatomic, readonly) MXRestClient *sendingnetworkRestClient;

/**
 The identity service used to handle Sendingnetwork identity server requests. Can be nil.
 */
...
/**
 The media manager used to handle the media stored on the Sendingnetwork Content repository.
 */
...
/**
 The user's sendingnetwork account data.
 */
@property (nonatomic, readonly) MXAccountData *accountData;

/**
 The store used to store user's Sendingnetwork data.
 */
...
/**
 ...
 However, the SDK or the application may want to continue so sync Sendingnetwork events while
 the app is in background.

 This method prevents the /sync from being paused so that the session continues to receive
 and process Sendingnetwork events.
...
#pragma mark - Options
/*
 Define the Sendingnetwork storage component to use.
...
/**
 ...
 @return a MXHTTPOperation instance.
 */
- (MXHTTPOperation*)supportedSendingnetworkVersions:(void (^)(MXSendingnetworkVersions *sendingnetworkVersions))success failure:(void (^)(NSError *error))failure NS_REFINED_FOR_SWIFT;
...
/**
 Retrieve a Sendingnetwork filter either from the store of from the homeserver.

 @param filterId the id of the Sendingnetwork filter to retrieve.
...
/**
 Force the sendingnetwork session to refresh the cached data related to the publicised groups of the users.
 */
- (void)markOutdatedPublicisedGroupsByUserData;

/**
 Get the current publicised groups for a sendingnetwork user.
