...
/**
 Sendingnetwork Client-Server API versions.
 */
struct MXSendingnetworkClientServerAPIVersionStruct
{
...
extern const struct MXSendingnetworkClientServerAPIVersionStruct MXSendingnetworkClientServerAPIVersion;

/**
 Features declared in the sendingnetwork specification.
 */
struct MXSendingnetworkVersionsFeatureStruct
{
...
extern const struct MXSendingnetworkVersionsFeatureStruct MXSendingnetworkVersionsFeature;

/**
 `MXSendingnetworkVersions` represents the versions of the Sendingnetwork specification supported
 by the home server.
 It is returned by the /versions API.
 */
@interface MXSendingnetworkVersions : MXJSONModel<NSCoding>
