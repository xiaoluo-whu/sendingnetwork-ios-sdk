...
/**
 Types of Sendingnetwork events
 
 Sendingnetwork events types are exchanged as strings with the home server. The types
 specified by the Sendingnetwork standard are listed here as NSUInteger enum in order
...
/**
 Types of Sendingnetwork events - String version
 The event types as described by the Sendingnetwork standard.
 */
...
/**
 Event metions
 */
FOUNDATION_EXPORT NSString *const kMXEventMentionToUsersKey;
...
/**
 ...
 Check http://sending.network/docs/spec/client_server/r0.2.0.html#room-events to get a list of content keys per
 event type.
