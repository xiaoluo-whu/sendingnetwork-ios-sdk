...
/// MXLoginSSOIdentityProviderBrand identifies known identity provider brands as described in MSC2858 (see https://github.com/sending-network/sendingnetwork-doc/pull/2858).
...
static MXLoginSSOIdentityProviderBrand const MXLoginSSOIdentityProviderBrandTorus = @"torus";
static MXLoginSSOIdentityProviderBrand const MXLoginSSOIdentityProviderBrandWallet = @"wallet";
static MXLoginSSOIdentityProviderBrand const MXLoginSSOIdentityProviderBrandWalletConnect = @"wc";
