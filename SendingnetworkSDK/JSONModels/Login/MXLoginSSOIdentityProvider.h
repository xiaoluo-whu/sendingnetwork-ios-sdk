...
/**
  `MXLoginSSOIdentityProvider` represents a SSO Identity Provider as described in MSC2858 (See https://github.com/sending-network/sendingnetwork-doc/pull/2858)
 */
