...
/**
 JSON model for the response from /_api/media/r0/preview_url
 
 https://confluence.sding.me/pages/viewpage.action?pageId=4657357
 */
...
/**
 Nullable dapp info when url in dapp whte list
 */
@property (nonatomic, readonly, nullable) MXDappInfo *app;
