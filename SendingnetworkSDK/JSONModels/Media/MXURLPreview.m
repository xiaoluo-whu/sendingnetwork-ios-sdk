...
static NSString * const kImageFileSizeJSONKey = @"sendingnetwork:image:size";
static NSString * const kDappInfoJSONKey = @"app";
...
+ (instancetype)modelFromJSON:(NSDictionary *)JSONDictionary
{
    ...
    MXJSONModelSetMXJSONModel(app, MXDappInfo.class, JSONDictionary[kDappInfoJSONKey])
...
- (NSDictionary *)JSONDictionary
{
    ...
    if (JSONDictionary)
    {
        ...
        if  (self.app)
        {
            JSONDictionary[kDappInfoJSONKey] = self.app;
...
- (instancetype)initWithCoder:(NSCoder *)coder
{
    ...
    if (self) {
        ...
        _app = [coder decodeObjectForKey:kDappInfoJSONKey];
    }
    return self;
}
...
- (void)encodeWithCoder:(NSCoder *)coder
{
    ...
    [coder encodeObject:_app forKey:kDappInfoJSONKey];
}
