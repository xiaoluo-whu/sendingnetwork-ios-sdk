...
/**
 `MXIdentityService` manages requests to Sendingnetwork identity servers and abstract identity server REST client token and version management.
 */
...
/**
 Retrieve user sendingnetwork ids from a list of 3rd party ids.
