...
/**
 `MXIdentityServerRestClient` makes requests to Sendingnetwork identity servers.
 */
...
/**
 The preferred API path prefix to use for requests (i.e. "_api/identity/v2").
 */
...
/**
 Retrieve a user sendingnetwork id from a 3rd party id (v1 API).
 
 @param address the id of the user in the 3rd party system.
 @param medium the 3rd party system (ex: "email").
 
 @param success A block object called when the operation succeeds. It provides the Sendingnetwork user id.
...
/**
 Retrieve user sendingnetwork ids from a list of 3rd party ids (v1 API).
...
/**
 Retrieve user sendingnetwork ids from a list of 3rd party ids (v2 API). Require informations from `hashDetailsWithSuccess:failure` request.
...
/**
 Check if API path prefix is reachable on identity server (i.e. "_api/identity/v2").
...
/**
 ...
 @param mxid the user sendingnetwork id.
