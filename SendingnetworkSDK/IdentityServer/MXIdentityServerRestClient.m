 ...
 */
NSString *const kMXIdentityAPIPrefixPathV1 = @"_api/identity/api/v1";
NSString *const kMXIdentityAPIPrefixPathV2 = @"_api/identity/v2";

/**
 MXIdentityServerRestClient error domain
 */
NSString *const MXIdentityServerRestClientErrorDomain = @"org.sendingnetwork.sdk.MXIdentityServerRestClientErrorDomain";
                                                      ...
                                                      switch (algorithm)
                                                      {
                                                          case MXIdentityServerHashAlgorithmNone:
                                                          {
                                                              [mappings enumerateKeysAndObjectsUsingBlock:^(id key, id value, BOOL* stop) {
                                                                  ...
                                                                  {
                                                                      // Medium, 3 pid, Sendingnetwork ID
