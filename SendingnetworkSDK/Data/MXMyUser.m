...
{
    MXWeakify(self);
    [self.mxSession.sendingnetworkRestClient setDisplayName:displayname success:^{
...
{
    MXWeakify(self);
    [_mxSession.sendingnetworkRestClient setAvatarUrl:avatarUrl success:^{
        MXStrongifyAndReturnIfNil(self);
...
{
    MXWeakify(self);
    [_mxSession.sendingnetworkRestClient setPresence:presence andStatusMessage:statusMessage success:^{
        MXStrongifyAndReturnIfNil(self);
