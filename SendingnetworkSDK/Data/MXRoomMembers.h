...
/**
 ...
 @param sendingnetworkSession the session to the home server.

 @return The newly-initialized MXRoomMembers.
 */
- (instancetype)initWithRoomState:(MXRoomState*)state andSendingnetworkSession:(MXSession*)sendingnetworkSession;
/**
