...
public class MXRoomSummaryMO: NSManagedObject {
    ...
    @NSManaged public var s_localUnreadMentionMeEventCount: Int16
    ...
    @NSManaged public var s_hasMentionMe: Bool
    ...
    internal func update(withRoomSummary summary: MXRoomSummaryProtocol,
        ...
        s_localUnreadMentionMeEventCount = Int16(min(summary.localUnreadMetionMeEventCount, UInt(Int16.max)))
        ...
        s_hasMentionMe = summary.hasMetionMe
...
extension MXRoomSummaryMO: MXRoomSummaryProtocol {
    ...
    public var localUnreadMetionMeEventCount: UInt {
        return UInt(s_localUnreadMentionMeEventCount)
    ...
    public var hasMetionMe: Bool {
        return s_hasMentionMe
    }
