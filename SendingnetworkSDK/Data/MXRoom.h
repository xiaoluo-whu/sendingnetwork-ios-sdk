...
/**
 The Sendingnetwork id of the room.
 */
...
/**
 The related sendingnetwork session.
 */
...
/**
 Indicate if is a favourite people or room.
 */
...
/**
 ...
 @return the new instance.
 */
- (id)initWithRoomId:(NSString *)roomId sendingnetworkSession:(MXSession *)mxSession andStore:(id<MXStore>)store;
...
/**
 ...
 @param roomId the id of the room.
 @param sendingnetworkSession the session to use.
 @return the new instance.
 */
