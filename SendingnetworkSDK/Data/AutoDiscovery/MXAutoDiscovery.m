...
- (nullable instancetype)initWithUrl:(NSString *)url
{
    ...
    if (self)
    {
        ...
        // The .well-known/sendingnetwork/client API is often just a static file returned with no content type.
        // Make our HTTP client compatible with this behavior
        restClient.acceptableContentTypes =  [NSSet setWithObjects:@"application/json", @"text/json", @"text/javascript",@"text/html", nil];
    }
    return self;
}
                                         ...
                                         complete:(void (^)(MXDiscoveredClientConfig * _Nonnull))complete
{
    ...
    MXHTTPOperation *operation;
    operation = [restClient supportedSendingnetworkVersions:^(MXSendingnetworkVersions *sendingnetworkVersions) {
