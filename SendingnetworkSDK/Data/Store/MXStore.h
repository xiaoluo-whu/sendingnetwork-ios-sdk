...
/**
 Store a sendingnetwork user.
 */
- (void)storeUser:(nonnull MXUser*)user;

/**
 Get the list of all stored sendingnetwork users.
...
#pragma mark - groups
/**
 Store a sendingnetwork group.
 */
- (void)storeGroup:(nonnull MXGroup*)group;

/**
 Get the list of all stored sendingnetwork groups.
...
/**
 Count the unread metion me events wrote in the store.
 
 @discussion: The returned count is relative to the local storage. The actual unread messages
 for a room may be higher than the returned value.
 
 @param roomId the room id.
 @param threadId the thread id to count unread  metion me events in. Pass nil not to filter by any thread.
 @param types an array of event types strings (MXEventTypeString).
 @return The number of unread metion me events which have their type listed in the provided array.
 */
- (NSUInteger)localUnreadMentionMeEventCount:(nonnull NSString*)roomId threadId:(nullable NSString*)threadId withTypeIn:(nullable NSArray*)types;
...
/**
 Supported Sendingnetwork versions by the homeserver.
 */
@property (nonatomic, readonly) MXSendingnetworkVersions * _Nullable supportedSendingnetworkVersions;

/**
 Store the supported Sendingnetwork versions.

 @param supportedSendingnetworkVersions the supported Sendingnetwork versions to store.
 */
- (void)storeSupportedSendingnetworkVersions:(nonnull MXSendingnetworkVersions*)supportedSendingnetworkVersions;
...
/**
 Store/retrieve the id of the Sendingnetwork filter used in /sync requests.
 */
