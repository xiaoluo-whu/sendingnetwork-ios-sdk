...
static NSString* const kEncodingKeySupportedSendingnetworkVersions = @"supportedSendingnetworkVersions";
...
- (id)initWithCoder:(NSCoder *)aDecoder
{
    ...
    if (self)
    {
        ...
        _supportedSendingnetworkVersions = dict[kEncodingKeySupportedSendingnetworkVersions];
...
-(void)encodeWithCoder:(NSCoder *)aCoder
{
    ...
    if (_supportedSendingnetworkVersions)
    {
        dict[kEncodingKeySupportedSendingnetworkVersions] = _supportedSendingnetworkVersions;
    }
...
- (id)copyWithZone:(NSZone *)zone
{
    ...
    metaData->_supportedSendingnetworkVersions = _supportedSendingnetworkVersions;
