...
/**
 ...
 @return the new instance.
 */
- (instancetype)initWithRoomId:(NSString *)roomId sendingnetworkSession:(MXSession *)mxSession andStore:(id<MXStore>)store;
...
/**
 The Sendingnetwork content URI of the room avatar.
 */
...
@property (nonatomic) NSUInteger localUnreadMetionMeEventCount;
/**
...
@property (nonatomic) MXKContact *inviteContact;
