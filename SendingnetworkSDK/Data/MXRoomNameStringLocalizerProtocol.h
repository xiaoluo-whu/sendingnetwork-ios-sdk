...
/**
 ...
 to provide string localizations for computing room name according to Sendingnetwork
 room summaries (https://github.com/sending-network/sendingnetwork-doc/issues/688).
