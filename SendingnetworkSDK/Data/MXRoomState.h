...
/**
 ...
 @param sendingnetworkSession the session to the home server. It is used to get information about the user
...
/**
 ...
 @param roomId the room id to the room.
 @param sendingnetworkSession the mxSession to the home server. It is used to get information about the user
                  currently connected to the home server.
...
/**
 ...
 When invited by a 3pid medium like email, the not-yet-registered-to-sendingnetwork user is indicated
