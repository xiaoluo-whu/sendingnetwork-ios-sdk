...
/**
 `MXUser` represents a user in Sendingnetwork.
 */
 ...
 */
- (void)updateFromHomeserverOfSendingnetworkSession:(MXSession*)mxSession success:(void (^)(void))success failure:(void (^)(NSError *error))failure;
