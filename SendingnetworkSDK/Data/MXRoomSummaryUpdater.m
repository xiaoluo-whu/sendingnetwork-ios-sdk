...
- (BOOL)session:(MXSession *)session updateRoomSummary:(MXRoomSummary *)summary withStateEvents:(NSArray<MXEvent *> *)stateEvents roomState:(MXRoomState*)roomState
{
    ...
    {
        // The server does not send yet room summary for invited rooms (https://github.com/sending-network/sendingnetwork-doc/issues/1679)
...
- (BOOL)updateSummaryDisplayname:(MXRoomSummary *)summary session:(MXSession *)session withServerRoomSummary:(MXRoomSyncSummary *)serverRoomSummary roomState:(MXRoomState *)roomState excludingUserIDs:(NSArray<NSString *> *)excludedUserIDs
{
    ...
    // Compute a display name according to algorithm provided by Sendingnetwork room summaries
    // (https://github.com/sending-network/sendingnetwork-doc/issues/688)
    ...
    else
    {
        ...
        // Use Sendingnetwork room summaries and heroes
        ...
        {
            NSArray *otherMembers = [self sortedOtherMembersInRoomState:roomState withSendingnetworkSession:session];
...
/**
 ...
 One known reason is https://github.com/sending-network/synapse/issues/4194.
...
- (BOOL)updateSummaryAvatar:(MXRoomSummary *)summary session:(MXSession *)session withServerRoomSummary:(MXRoomSyncSummary *)serverRoomSummary roomState:(MXRoomState *)roomState excludingUserIDs:(NSArray<NSString *> *)excludedUserIDs
{
    ...
    else if (summary.isDirect)
    {
        ...
        {
            NSArray<MXRoomMember*> *otherMembers = [self sortedOtherMembersInRoomState:roomState withSendingnetworkSession:session];
...
- (NSArray<MXRoomMember*> *)sortedOtherMembersInRoomState:(MXRoomState*)roomState withSendingnetworkSession:(MXSession *)session
{
