...
/**
 Create the room member from a Sendingnetwork room member event.
...
/**
 Create the room member from a Sendingnetwork room member event by specifying the content to use.
