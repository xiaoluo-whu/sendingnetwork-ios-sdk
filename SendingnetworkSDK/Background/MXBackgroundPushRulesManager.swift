...
@objcMembers public class MXBackgroundPushRulesManager: NSObject {
    ...
    public init(withCredentials credentials: MXCredentials) {
        ...
        memberCountConditionChecker = MXPushRuleRoomMemberCountConditionChecker(sendingnetworkSession: nil)
        permissionConditionChecker = MXPushRuleSenderNotificationPermissionConditionChecker(sendingnetworkSession: nil)
        super.init()
    }
    ...
    public func pushRule(matching event: MXEvent,
        ...
        let displayNameChecker = MXPushRuleDisplayNameCondtionChecker(sendingnetworkSession: nil,
