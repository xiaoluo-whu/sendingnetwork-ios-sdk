...
class MXBackgroundStore: NSObject, MXStore {
    ...
    func localUnreadMentionMeEventCount(_ roomId: String, threadId: String?, withTypeIn types: [Any]?) -> UInt {
        return 0
    }
    ...
    var supportedSendingnetworkVersions: MXSendingnetworkVersions?
    func storeSupportedSendingnetworkVersions(_ supportedSendingnetworkVersions: MXSendingnetworkVersions) {
    }
