...
/**
 Sendingnetwork error codes
 The error as described by the Sendingnetwork standard (http://sending.network/docs/spec/#api-standards).
 */
...
/**
 Keys and values that can be found in a Sendingnetwork error JSON dictionary.
 */
...
/**
 Check if an NSError is in the Sendingnetwork error domain
