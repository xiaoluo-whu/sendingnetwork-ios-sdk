...
extension MXSpaceError: CustomNSError {
    public static let errorDomain = "org.sendingnetwork.sdk.space"
...
public class MXSpace: NSObject {
    ...
    public init(roomId: String, session: MXSession) {
        ...
        self.processingQueue = DispatchQueue(label: "org.sendingnetwork.sdk.MXSpace.processingQueue", attributes: .concurrent)
