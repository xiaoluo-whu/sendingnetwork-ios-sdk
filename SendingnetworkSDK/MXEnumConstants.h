...
/**
 Scheme used in Sendingnetwork content URIs.
 */
FOUNDATION_EXPORT NSString *const kMXContentUriScheme;
/**
 A constant representing the default prefix of the Sendingnetwork content repository path.
 */
FOUNDATION_EXPORT NSString *const kMXContentPrefixPath;
/**
 Domain used for random avatar links.
 */
FOUNDATION_EXPORT NSString *const kBoringAvatarsDomain;
...
/**
 Methods of thumnailing supported by the Sendingnetwork content repository.
 */
...
FOUNDATION_EXPORT NSString *const kMXRoomJoinRuleTokenAccess;
/**
 Room presets
...
/**
 Format for room message event with a "formatted_body" using the "org.sendingnetwork.custom.html" format.
 */
...
/**
 The sendingnetwork.to base URL.
 */
FOUNDATION_EXPORT NSString *const kMXSendingnetworkDotToUrl;
