...
/**
 The `MXCallManager` object manages calls for a given Sendingnetwork session.
 It manages call signaling over Sendingnetwork (@see http://sending.network/docs/spec/#id9) and then opens
 ...
 */
- (instancetype)initWithSendingnetworkSession:(MXSession *)mxSession andCallStack:(id<MXCallStack>)callstack NS_DESIGNATED_INITIALIZER;
