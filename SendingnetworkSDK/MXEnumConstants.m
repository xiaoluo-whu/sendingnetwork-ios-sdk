...
/**
 Sendingnetwork content respository path
 */
NSString *const kMXContentUriScheme  = @"mxc://";
NSString *const kMXContentPrefixPath = @"_api/media/r0";
NSString *const kBoringAvatarsDomain = @"https://source.boringavatars.com";
...
NSString *const kMXRoomJoinRuleTokenAccess  = @"tokenAccess";
...
NSString *const kMXRoomMessageFormatHTML = @"org.sendingnetwork.custom.html";

NSString *const kMXSendingnetworkDotToUrl = @"https://sendingnetwork.to";
