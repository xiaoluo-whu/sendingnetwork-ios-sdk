...
public extension MXIdentityServerRestClient {
    ...
    /**
     Retrieve a user sendingnetwork id from a 3rd party id.
     
     - parameters:
     - descriptor: the 3PID descriptor of the user in the 3rd party system.
     - completion: A block object called when the operation completes.
     - response: Provides the Sendingnetwork user id (or `nil` if the user is not found) on success.
    ...
    /**
     ...
     - mxid: the user sendingnetwork id.
     - completion: A block object called when the operation completes.
