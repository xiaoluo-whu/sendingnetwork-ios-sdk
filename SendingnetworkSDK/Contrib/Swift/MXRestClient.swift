...
public extension MXRestClient {
    ...
    /**
     ...
     As described in [the specification](http://sending.network/docs/spec/client_server/r0.2.0.html#client-authentication),
    ...
    /**
     ...
     - parameters:
         ...
         - username: the user id (ex: "@bob:sending.network") or the user id localpart (ex: "bob") of the user to register. Can be nil.
    ...
    /**
     ...
     - parameters:
         ...
         - username: the user id (ex: "@bob:sending.network") or the user id localpart (ex: "bob") of the user to authenticate.
         - password: the user's password.
    ...
    /**
     ...
     - parameters:
        - joinRule: the rule to set.
        - roomId: the id of the room.
        - allowedParentIds: Optional: list of allowedParentIds (required only for `restricted` join rule as per [MSC3083](https://github.com/sending-network/sendingnetwork-doc/pull/3083) )
        - completion: A block object called when the operation completes.
        - response: Indicates whether the operation was successful.
    ...
    /**
     ...
     - parameters:
        - roomId: the id of the room.
        - completion: A block object called when the operation completes. It provides the room enhanced join rule as per [MSC3083](https://github.com/sending-network/sendingnetwork-doc/pull/3083.
        - response: Provides the room join rule on success.
    ...
    /**
     ...
     - parameters:
        - parameters: The parameters. Refer to the sendingnetwork specification for details.
        - completion: A block object called when the operation completes.
        - response: Provides a MXCreateRoomResponse object on success.
    ...
    /**
     ...
     See [the sendingnetwork documentation on state events](http://sending.network/docs/api/client-server/#!/-rooms/get_state_events)
     for more detail.
    ...
    /**
     ...
     See [the sendingnetwork documentation](http://sending.network/docs/api/client-server/#!/-rooms/get_room_sync_data)
     for more detail.
    ...
    /**
     ...
     - parameters:
        ...
        - via: servers, that should be tried to request a summary from, if it can't be generated locally. These can be from a sendingnetwork URI, sendingnetwork.to link or a `m.space.child` event for example.
        - completion: A block object called when the operation completes.
        - response: Provides the model created from the homeserver JSON response on success.
    ...
    /**
     ...
     - parameters:
        ...
        - bind: whether the homeserver should also bind this third party identifier to the account's Sendingnetwork ID with the identity server.
        - completion: A block object called when the operation completes.
        - response:  Indicates whether the operation was successful.
    ...
    */
    ...
    /**
     ...
     - parameters:
        - parameters: the search parameters as defined by the Sendingnetwork search spec (http://sending.network/docs/api/client-server/#!/Search/post_search ).
        - nextBatch: the token to pass for doing pagination from a previous response.
        - completion: A block object called when the operation completes.
        - response: Provides the search results on success.
