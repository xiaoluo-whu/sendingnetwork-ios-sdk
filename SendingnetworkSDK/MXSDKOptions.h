...
/**
 By default Sendingnetwork SDK sets an identicon url when user's avatar is undefined
...
/**
 Custom domain to use to fetch the sendingnetwork client wellknown.
...
/**
 For use in clients that use a custom base url for permalinks rather than sendingnetwork.to.
 This baseURL is used to generate permalinks within the app (E.g. timeline message permalinks).
 An Optional String, when nil sendingnetwork.to format/hostname is used instead.
 */
...
/**
 ...
 of [sendingnetwork-rust-sdk](https://github.com/sending-network/sendingnetwork-rust-sdk/tree/main/crates/sendingnetwork-sdk-crypto).
