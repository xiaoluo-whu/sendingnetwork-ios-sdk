   ...
   readyToTest:(void (^)(MXRoom *room))readyToTest
{
    ...
    [sendingnetworkSDKTestsData doMXRestClientTestWithBobAndARoomWithMessages:testCase readyToTest:^(MXRestClient *bobRestClient, NSString *roomId, XCTestExpectation *expectation2) {
            ...
            readyToTest:(void (^)(MXRoom *room))readyToTest
{
    ...
    [sendingnetworkSDKTestsData doMXRestClientTestWithBobAndAliceInARoom:testCase readyToTest:^(MXRestClient *bobRestClient, MXRestClient *aliceRestClient, NSString *roomId, XCTestExpectation *expectation2) {

        [sendingnetworkSDKTestsData for:bobRestClient andRoom:roomId sendMessages:5 testCase:testCase success:^{
...
{
    [sendingnetworkSDKTestsData doMXRestClientTestWithBob:self readyToTest:^(MXRestClient *bobRestClient, XCTestExpectation *expectation2) {
...
- (void)checkSeveralPaginateBacks:(MXRoom*)room
{
    ...
    [room liveTimeline:^(id<MXEventTimeline> liveTimeline) {
        ...
        [liveTimeline paginate:100 direction:MXTimelineDirectionBackwards onlyFromStore:NO complete:^() {
            ...
            MXRoom *room2 = [[MXRoom alloc] initWithRoomId:room.roomId andSendingnetworkSession:mxSession];
...
- (void)checkPaginateWhenJoiningAgainAfterLeft:(MXRoom*)room
{
    [sendingnetworkSDKTestsData doMXRestClientTestWithAlice:nil readyToTest:^(MXRestClient *aliceRestClient, XCTestExpectation *expectation2) {
        ...
        [mxSession.sendingnetworkRestClient inviteUser:aliceRestClient.credentials.userId toRoom:room.roomId success:^{
            ...
            [aliceRestClient joinRoom:roomId viaServers:nil withThirdPartySigned:nil success:^(NSString *roomName){
                ...
                [room leave:^{
                    ...
                    [aliceRestClient sendTextMessageToRoom:roomId threadId:nil text:@"Hi bob" success:^(NSString *eventId) {
                        ...
                        [aliceRestClient inviteUser:mxSession.sendingnetworkRestClient.credentials.userId toRoom:roomId success:^{
...
// Test for https://sending.network/jira/browse/SYN-162
...
{
    [sendingnetworkSDKTestsData doMXRestClientTestWithAlice:self readyToTest:^(MXRestClient *aliceRestClient, XCTestExpectation *expectation2) {

        expectation = expectation2;

        id<MXStore> store = [[mxStoreClass alloc] init];
        [store openWithCredentials:sendingnetworkSDKTestsData.aliceCredentials onComplete:^{
            ...
            mxSession = [[MXSession alloc] initWithSendingnetworkRestClient:aliceRestClient];
            [sendingnetworkSDKTestsData retain:mxSession];
            ...
            [mxSession setStore:store success:^{
                ...
                [mxSession start:^{
                    ...
                    [store2 openWithCredentials:sendingnetworkSDKTestsData.aliceCredentials onComplete:^{
            ...
            [mxSession setStore:store success:^{
                ...
                [mxSession start:^{
                    ...
                    [mxSession.myUser setDisplayName:@"Alicia" success:^{
                        ...
                        [mxSession.myUser setAvatarUrl:@"http://sending.network/sendingnetwork.png" success:^{

                            XCTAssertEqualObjects(myUser.avatarUrl, @"http://sending.network/sendingnetwork.png");
...
{
    [sendingnetworkSDKTestsData doMXRestClientTestWithBobAndARoomWithMessages:self readyToTest:^(MXRestClient *bobRestClient, NSString *roomId, XCTestExpectation *expectation2) {

        expectation = expectation2;


        id<MXStore> store = [[mxStoreClass alloc] init];
        [store openWithCredentials:sendingnetworkSDKTestsData.bobCredentials onComplete:^{

            // Make sure to start from an empty store
            [store deleteAllData];

            MXUser *myUser = [store userWithUserId:sendingnetworkSDKTestsData.bobCredentials.userId];
                ...
                [mxSession start:^{
                    ...
                    [bobRestClient createRoom:nil visibility:kMXRoomDirectoryVisibilityPrivate roomAlias:nil topic:nil success:^(MXCreateRoomResponse *response) {
                        ...
                        [bobRestClient sendTextMessageToRoom:response.roomId threadId:nil text:@"A Message" success:^(NSString *eventId) {
                            ...
                            MXSession *mxSession2 = [[MXSession alloc] initWithSendingnetworkRestClient:bobRestClient];
        ...
        [mxSession setStore:store success:^{
            ...
            [mxSession start:^{
                ...
                [room leave:^{
                    ...
                    id<MXStore> store2 = [[mxStoreClass alloc] init];
                    [store2 openWithCredentials:sendingnetworkSDKTestsData.bobCredentials onComplete:^{
...
{
    [sendingnetworkSDKTestsData doMXRestClientTestWithBobAndAliceInARoom:self readyToTest:^(MXRestClient *bobRestClient, MXRestClient *aliceRestClient, NSString *roomId, XCTestExpectation *expectation2) {
        ...
        [mxSession setStore:bobStore1 success:^{
            [mxSession start:^{
                ...
                [bobStore2 openWithCredentials:sendingnetworkSDKTestsData.bobCredentials onComplete:^{

                    id<MXStore> aliceStore = [[mxStoreClass alloc] init];
                    [sendingnetworkSDKTestsData retain:aliceStore];

                    [aliceStore openWithCredentials:sendingnetworkSDKTestsData.aliceCredentials onComplete:^{

                        id<MXStore> bobStore3 = [[mxStoreClass alloc] init];
                        [bobStore3 openWithCredentials:sendingnetworkSDKTestsData.bobCredentials onComplete:^{
