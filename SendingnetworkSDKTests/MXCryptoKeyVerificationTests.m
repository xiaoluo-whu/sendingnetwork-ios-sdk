...
- (void)testVerificationByToDeviceRequests
{
    ...
    [sendingnetworkSDKTestsE2EData doE2ETestWithAliceAndBobInARoomWithCryptedMessages:self cryptedBob:YES readyToTest:^(MXSession *aliceSession, MXSession *bobSession, NSString *roomId, XCTestExpectation *expectation) {
        ...
        MXCredentials *alice = aliceSession.sendingnetworkRestClient.credentials;
...
- (void)checkVerificationByToDeviceFullFlowWithBobSession:(MXSession*)bobSession aliceSession:(MXSession*)aliceSession roomId:(NSString*)roomId expectation:(XCTestExpectation*)expectation
{
    ...
    MXCredentials *alice = aliceSession.sendingnetworkRestClient.credentials;
    MXCredentials *bob = bobSession.sendingnetworkRestClient.credentials;
...
{
    // - Alice and Bob are in a room
    [sendingnetworkSDKTestsE2EData doE2ETestWithAliceAndBobInARoom:self cryptedBob:YES warnOnUnknowDevices:YES aliceStore:[[MXMemoryStore alloc] init] bobStore:[[MXMemoryStore alloc] init] readyToTest:^(MXSession *aliceSession, MXSession *bobSession, NSString *roomId, XCTestExpectation *expectation) {
...
- (void)testVerificationByToDeviceFullFlowWith2Devices
{
    ...
    [sendingnetworkSDKTestsE2EData doE2ETestWithAliceAndBobInARoom:self cryptedBob:YES warnOnUnknowDevices:YES aliceStore:[[MXMemoryStore alloc] init] bobStore:[[MXMemoryStore alloc] init] readyToTest:^(MXSession *aliceSession, MXSession *bobSession, NSString *roomId, XCTestExpectation *expectation) {
        ...
        [sendingnetworkSDKTestsE2EData loginUserOnANewDevice:self credentials:bobSession.sendingnetworkRestClient.credentials withPassword:MXTESTS_BOB_PWD onComplete:^(MXSession *newBobSession) {
...
{
    // - Have Alice with 3 sessions
    [sendingnetworkSDKTestsE2EData doE2ETestWithAliceAndBobInARoom:self cryptedBob:YES warnOnUnknowDevices:YES aliceStore:[[MXMemoryStore alloc] init] bobStore:[[MXMemoryStore alloc] init] readyToTest:^(MXSession *aliceSession1, MXSession *bobSession, NSString *roomId, XCTestExpectation *expectation) {
        
        [sendingnetworkSDKTestsE2EData loginUserOnANewDevice:self credentials:aliceSession1.sendingnetworkRestClient.credentials withPassword:MXTESTS_ALICE_PWD onComplete:^(MXSession *aliceSession2) {
            ...
            [sendingnetworkSDKTestsE2EData loginUserOnANewDevice:self credentials:aliceSession1.sendingnetworkRestClient.credentials withPassword:MXTESTS_ALICE_PWD onComplete:^(MXSession *aliceSession3) {
                ...
                NSString *aliceSession3DeviceId = aliceSession3.sendingnetworkRestClient.credentials.deviceId;
...
{
    // - Alice and Bob are in a room
    [sendingnetworkSDKTestsE2EData doE2ETestWithBobAndAlice:self readyToTest:^(MXSession *aliceSession, MXSession *bobSession, XCTestExpectation *expectation) {
