...
- (void)doTestWithARoomOf41Messages:(XCTestCase*)testCase readyToTest:(void (^)(MXRoom *room, XCTestExpectation *expectation, NSString *initialEventId))readyToTest
{
    [sendingnetworkSDKTestsData doMXSessionTestWithBobAndARoomWithMessages:self readyToTest:^(MXSession *mxSession, MXRoom *room, XCTestExpectation *expectation) {
        ...
        [sendingnetworkSDKTestsData for:mxSession.sendingnetworkRestClient andRoom:room.roomId sendMessages:20 testCase:testCase success:^{
        ...
        [eventTimeline resetPaginationAroundInitialEventWithLimit:10 success:^{
            ...
            [eventTimeline paginate:10 direction:MXTimelineDirectionBackwards onlyFromStore:NO complete:^{
                ...
                [eventTimeline paginate:100 direction:MXTimelineDirectionBackwards onlyFromStore:NO complete:^{
                    ...
                    // @TODO: The result should be 26 but it fails because of https://sending.network/jira/browse/SYN-641
                    // @TODO: Come back to 26 once Synapse is fixed
                    //XCTAssertEqual(events.count, 26, @"20 + 1 + 5 = 26");
                    XCTAssertEqual(events.count, 31, @"If the result 26, this means that https://sending.network/jira/browse/SYN-641 is fixed ");
