                          ...
                          readyToTest:(void (^)(MXSession *aliceSession, MXSession *bobSession, MXSession *charlieSession, NSString* roomId, XCTestExpectation *expectation))readyToTest
{
    ...
    [sendingnetworkSDKTestsData doMXSessionTestWithBobAndAliceInARoom:self readyToTest:^(MXSession *bobSession, MXRestClient *aliceRestClient, NSString *roomId, XCTestExpectation *expectation) {
        ...
        [roomFromBobPOV setJoinRule:kMXRoomJoinRulePublic success:^{
            ...
            // - Charlie joins the room
            [sendingnetworkSDKTestsData doMXSessionTestWithAUser:nil readyToTest:^(MXSession *charlieSession, XCTestExpectation *expectation2) {
                [charlieSession joinRoom:roomId viaServers:nil success:^(MXRoom *room) {
                    ...
                    [roomFromBobPOV inviteUser:@"@dave:localhost:8480" success:^{
                        ...
                        //  - Alice sends 50 messages
                        [sendingnetworkSDKTestsData for:aliceRestClient andRoom:roomId sendMessages:50 testCase:self success:^{
                            ...
                            [roomFromBobPOV sendTextMessage:bobMessage threadId:nil success:^(NSString *eventId) {
                                ...
                                [sendingnetworkSDKTestsData for:aliceRestClient andRoom:roomId sendMessages:50 testCase:self success:^{
                                    ...
                                    MXSession *aliceSession = [[MXSession alloc] initWithSendingnetworkRestClient:aliceRestClient];
                                    [sendingnetworkSDKTestsData retain:aliceSession];
...
- (void)checkRoomMembersAfterLimitedSyncWithLazyLoading:(BOOL)lazyLoading
{
    ...
    [self createScenarioWithLazyLoading:lazyLoading readyToTest:^(MXSession *aliceSession, MXSession *bobSession, MXSession *charlieSession, NSString *roomId, XCTestExpectation *expectation) {
        ...
        [sendingnetworkSDKTestsData doMXSessionTestWithAUser:nil readyToTest:^(MXSession *eve0Session, XCTestExpectation *expectation2) {
            [eve0Session joinRoom:roomId viaServers:nil success:^(MXRoom *room) {

                [sendingnetworkSDKTestsData doMXSessionTestWithAUser:nil readyToTest:^(MXSession *eve1Session, XCTestExpectation *expectation2) {
                    [eve1Session joinRoom:roomId viaServers:nil success:^(MXRoom *room) {

                        [sendingnetworkSDKTestsData doMXSessionTestWithAUser:nil readyToTest:^(MXSession *eve2Session, XCTestExpectation *expectation2) {
                            [eve2Session joinRoom:roomId viaServers:nil success:^(MXRoom *room) {

                                [sendingnetworkSDKTestsData doMXSessionTestWithAUser:nil readyToTest:^(MXSession *eve3Session, XCTestExpectation *expectation2) {
                                    [eve3Session joinRoom:roomId viaServers:nil success:^(MXRoom *room) {

                                        [sendingnetworkSDKTestsData doMXSessionTestWithAUser:nil readyToTest:^(MXSession *eve4Session, XCTestExpectation *expectation2) {
                                            [eve4Session joinRoom:roomId viaServers:nil success:^(MXRoom *room) {


                                                // - Eve0 sends 20 messages
                                                [sendingnetworkSDKTestsData for:eve0Session.sendingnetworkRestClient andRoom:roomId sendMessages:20 testCase:self success:^{
...
- (void)checkSummaryMembershipWithLazyLoading:(BOOL)lazyLoading
{
    [self createScenarioWithLazyLoading:lazyLoading readyToTest:^(MXSession *aliceSession, MXSession *bobSession, MXSession *charlieSession, NSString *roomId, XCTestExpectation *expectation) {
        ...
        [room state:^(MXRoomState *roomState) {
            ...
            MXSession *charlieSession2 = [[MXSession alloc] initWithSendingnetworkRestClient:charlieSession.sendingnetworkRestClient];
            [charlieSession close];
            [sendingnetworkSDKTestsData retain:charlieSession2];
...
- (void)checkRoomAfterLeavingFromAnotherDeviceWithLazyLoading:(BOOL)lazyLoading
{
    ...
    [self createScenarioWithLazyLoading:lazyLoading readyToTest:^(MXSession *aliceSession, MXSession *bobSession, MXSession *charlieSession, NSString *roomId, XCTestExpectation *expectation) {
        ...
        // - Make her leave the room outside her MXSession
        [aliceSession.sendingnetworkRestClient leaveRoom:roomId success:^{

            // - Bob sends 50 messages
            [sendingnetworkSDKTestsData for:bobSession.sendingnetworkRestClient andRoom:roomId sendMessages:50 testCase:self success:^{
...
- (void)checkRoomAfterLeavingWithLazyLoading:(BOOL)lazyLoading
{
    ...
    [self createScenarioWithLazyLoading:lazyLoading readyToTest:^(MXSession *aliceSession, MXSession *bobSession, MXSession *charlieSession, NSString *roomId, XCTestExpectation *expectation) {
        ...
        __block MXSession *aliceSession2 = [[MXSession alloc] initWithSendingnetworkRestClient:aliceRestClient];
...
// Check Synapse issue (https://github.com/sending-network/synapse/issues/4194): the CS API should provide heroes if room name is ""
...
// Check use case described in https://github.com/sending-network/sendingnetwork-ios-sdk/pull/605
...
- (void)checkSearchWithLazyLoading:(BOOL)lazyLoading
{
    [self createScenarioWithLazyLoading:lazyLoading readyToTest:^(MXSession *aliceSession, MXSession *bobSession, MXSession *charlieSession, NSString *roomId, XCTestExpectation *expectation) {
        ...
        [aliceSession.sendingnetworkRestClient searchMessagesWithText:bobMessage roomEventFilter:nil beforeLimit:0 afterLimit:0 nextBatch:nil success:^(MXSearchRoomEventResults *roomEventResults) {
