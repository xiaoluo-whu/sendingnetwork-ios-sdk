...
static NSString* const kDefaultAntivirusServerDomain = @"sending.network";
...
{
    NSString *eventId = @"123456igzeoijncvoiuhekaj:sending.network";
    
    MXAntivirusScanStatus initialAntivirusScanStatus = MXAntivirusScanStatusInProgress;
    
    NSArray<NSString*>* mediaURLs = @[
                                      @"mxc://sending.network/7398H34PHL3904U",
                                      @"mxc://sending.network/7398H34PHL3904V"
                                      ];
...
- (void)testUpdateEventMediaScans
{
    ...
    NSArray<NSString*>* mediaURLsAtUpdate = @[
                                              @"mxc://sending.network/7398H34PHL3904V",
                                              @"mxc://sending.network/7398H34PHL3904W",
                                              @"mxc://sending.network/7398H34PHL3904X"
                                              ];
