...
- (void)testPeeking
{
    [sendingnetworkSDKTestsData doMXSessionTestWithBobAndThePublicRoom:self readyToTest:^(MXSession *mxSession2, MXRoom *room, XCTestExpectation *expectation) {

        [room setHistoryVisibility:kMXRoomHistoryVisibilityWorldReadable success:^{

            [sendingnetworkSDKTestsData doMXSessionTestWithAlice:nil readyToTest:^(MXSession *mxSession, XCTestExpectation *expectation2) {
