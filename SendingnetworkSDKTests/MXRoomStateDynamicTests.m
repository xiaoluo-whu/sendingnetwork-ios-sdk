...
- (void)createScenario2:(MXRestClient*)bobRestClient inRoom:(NSString*)roomId expectation:(XCTestExpectation*)expectation onComplete:(void(^)(MXRestClient *aliceRestClient))onComplete
{
    [bobRestClient sendTextMessageToRoom:roomId threadId:nil text:@"Hello world" success:^(NSString *eventId) {
        ...
        [sendingnetworkSDKTestsData doMXRestClientTestWithAlice:nil readyToTest:^(MXRestClient *aliceRestClient, XCTestExpectation *expectation2) {
            ...
            [bobRestClient inviteUser:sendingnetworkSDKTestsData.aliceCredentials.userId toRoom:roomId success:^{
    ...
    [sendingnetworkSDKTestsData doMXRestClientTestWithBobAndARoom:self readyToTest:^(MXRestClient *bobRestClient, NSString *roomId, XCTestExpectation *expectation) {
        ...
        [mxSession start:^{
            ...
            [room listenToEventsOfTypes:nil onEvent:^(MXEvent *event, MXTimelineDirection direction, MXRoomState *roomState) {
                ...
                MXRoomMember *beforeEventAliceMember = [roomstate.members memberWithUserId:sendingnetworkSDKTestsData.aliceCredentials.userId];
                MXRoomMember *aliceMember = [room.state.members memberWithUserId:sendingnetworkSDKTestsData.aliceCredentials.userId];
