...
{
    [sendingnetworkSDKTestsData doMXSessionTestWithBobAndThePublicRoom:self readyToTest:^(MXSession *mxSession, MXRoom *room, XCTestExpectation *expectation) {
...
{
    [sendingnetworkSDKTestsData doMXSessionTestWithBobAndARoomWithMessages:self readyToTest:^(MXSession *mxSession, MXRoom *room, XCTestExpectation *expectation) {
...
- (void)testRoomTopicProvidedByInitialSync
{
    [sendingnetworkSDKTestsData doMXRestClientTestInABobRoomAndANewTextMessage:self newTextMessage:@"This is a text message for recents" onReadyToTest:^(MXRestClient *bobRestClient, NSString *roomId, NSString *new_text_message_eventId, XCTestExpectation *expectation) {
        ...
        [bobRestClient setRoomTopic:roomId topic:@"My topic" success:^{
            ...
            MXSession *mxSession = [[MXSession alloc] initWithSendingnetworkRestClient:bobRestClient2];
        ...
        [bobRestClient setRoomAvatar:roomId avatar:@"http://sending.network/sendingnetwork.png" success:^{
            ...
            [mxSession start:^{
                ...
                [room state:^(MXRoomState *roomState) {
                    ...
                    XCTAssertEqualObjects(roomState.avatar, @"http://sending.network/sendingnetwork.png");
        ...
        [mxSession start:^{
            ...
            [room liveTimeline:^(id<MXEventTimeline> liveTimeline) {
                ...
                [liveTimeline listenToEventsOfTypes:nil onEvent:^(MXEvent *event, MXTimelineDirection direction, MXRoomState *roomState) {
                    ...
                    XCTAssertEqualObjects(liveTimeline.state.avatar, @"http://sending.network/sendingnetwork.png");
                ...
                // Change the avatar
                [bobRestClient2 setRoomAvatar:roomId avatar:@"http://sending.network/sendingnetwork.png" success:^{
...
- (void)testMemberName
{
    [sendingnetworkSDKTestsData doMXSessionTestWithBobAndThePublicRoom:self readyToTest:^(MXSession *mxSession, MXRoom *room, XCTestExpectation *expectation) {
        ...
        NSString *bobUserId = sendingnetworkSDKTestsData.bobCredentials.userId;
        ...
        [bobRestClient setRoomName:roomId name:@"Invite test" success:^{
            ...
            [bobRestClient setRoomTopic:roomId topic:@"We test room invitation here" success:^{
                ...
                [sendingnetworkSDKTestsData doMXRestClientTestWithAlice:nil readyToTest:^(MXRestClient *aliceRestClient, XCTestExpectation *expectation2) {
                    ...
                    if (inviteAlice)
                    {
                        [bobRestClient2 inviteUser:sendingnetworkSDKTestsData.aliceCredentials.userId toRoom:roomId success:^{
...
- (void)testInviteByOtherInInitialSync
{
    [sendingnetworkSDKTestsData doMXRestClientTestWithBobAndARoom:self readyToTest:^(MXRestClient *bobRestClient, NSString *roomId, XCTestExpectation *expectation) {
        ...
        [self createInviteByUserScenario:bobRestClient inRoom:roomId inviteAlice:YES expectation:expectation onComplete:^{
            ...
            [sendingnetworkSDKTestsData doMXSessionTestWithAlice:nil andStore:[MXMemoryStore new] readyToTest:^(MXSession *mxSession, XCTestExpectation *expectation2) {
...
// Test for https://sending.network/jira/browse/SYIOS-105
- (void)testRoomStateWhenARoomHasBeenJoinedOnAnotherSendingnetworkClient
{
    [sendingnetworkSDKTestsData doMXRestClientTestWithAlice:self readyToTest:^(MXRestClient *aliceRestClient, XCTestExpectation *expectation) {
        ...
        [mxSession start:^{
            ...
            [sendingnetworkSDKTestsData doMXRestClientTestWithBobAndAliceInARoom:nil readyToTest:^(MXRestClient *bobRestClient, MXRestClient *aliceRestClient, NSString *roomId, XCTestExpectation *expectation) {
...
// Test for https://sending.network/jira/browse/SYIOS-105 using notifications
- (void)testRoomStateWhenARoomHasBeenJoinedOnAnotherSendingnetworkClientAndNotifications {
    [sendingnetworkSDKTestsData doMXRestClientTestWithAlice:self readyToTest:^(MXRestClient *aliceRestClient, XCTestExpectation *expectation) {
