...
// Make sure the ignoredUsers list is still here after resuming a Sendingnetwork app
                    ...
                    if (notif.object == bobSession)
                    {
                        ...
                        dispatch_async(dispatch_get_main_queue(), ^{
                            dispatch_async(dispatch_get_main_queue(), ^{
                                ...
                                MXSession *bobSession2 = [[MXSession alloc] initWithSendingnetworkRestClient:bobRestClient];
