...
@interface SendingnetworkSDKTestsData : NSObject
...
/// Close automatically MXSession instances created by SendingnetworkSDKTestsData.
/// True by default.
/// Those instances are closed on SendingnetworkSDKTestsData.deinit()
@property (nonatomic) BOOL autoCloseMXSessions;

// Retain an object for the life of this SendingnetworkSDKTestsData instance
