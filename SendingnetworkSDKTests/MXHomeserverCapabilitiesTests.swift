...
class MXHomeserverCapabilitiesTests: XCTestCase {
        ...
        "capabilities": [
            ...
            "m.room_versions": [
                ...
                "available": [
                    ...
                    "8": "stable",
                    "9": "stable",
                    "org.sendingnetwork.msc2176": "unstable",
                    "org.sendingnetwork.msc2716v3": "unstable"
                ]
            ]
        ]
    ]
    ...
    [
        "capabilities": [
            ...
            "m.room_versions": [
                ...
                "org.sendingnetwork.msc3244.room_capabilities": [
                    "knock": [
                        "preferred": "7",
                        "support": [
                            "7",
    ...
    [
        "capabilities": [
            ...
            "m.room_versions": [
                ...
                "org.sendingnetwork.msc3244.room_capabilities": [
                    "knock": [
                        "preferred": "org.sendingnetwork.msc2176",
                        "support": [
                            "7",
                            "8",
                            "9",
                    ...
                    "restricted": [
                        "preferred": "org.sendingnetwork.msc2716v3",
                        "support": [
                            "8",
                            "9"
                        ]
    ...
    private var testData: SendingnetworkSDKTestsData!
    
    // MARK: - Setup
    
    override func setUpWithError() throws {
        // Put setup code here. This method is called before the invocation of each test method in the class.
        testData = SendingnetworkSDKTestsData()
    }
    ...
    /// - Create Bob
    /// - Setup Bob session
    /// - setup home server capabilties service with an repsponse without `org.sendingnetwork.msc3244.room_capabilities` entry
    ///
    /// -> Check canChangePassword, isFeatureSupported, and versionOverrideForFeature responses
    ...
    func testUnstableCapabilties() throws {
        setup(capabilities: Self.unstableCapabilities, andCheck: [
            ...
            .featureSupportedByRoomVersion(.knock, "6", false),
            .featureSupportedByRoomVersion(.knock, "9", true),
            .versionOverride(.knock, "org.sendingnetwork.msc2176"),
            .featureSupported(.restricted, .supportedUnstable),
            .featureSupportedByRoomVersion(.restricted, "6", false),
            .featureSupportedByRoomVersion(.restricted, "9", true),
            .versionOverride(.restricted, "org.sendingnetwork.msc2716v3")
        ])
    }
    ...
    func testNoPreferredCapabilties() throws {
        setup(capabilities: Self.noPreferredCapabilities, andCheck: [
            ...
            .featureSupportedByRoomVersion(.knock, "6", false),
            .featureSupportedByRoomVersion(.knock, "9", true),
            .versionOverride(.knock, "org.sendingnetwork.msc2716v3"),
            .featureSupported(.restricted, .supported),
            .featureSupportedByRoomVersion(.restricted, "6", false),
            .featureSupportedByRoomVersion(.restricted, "9", true),
            .versionOverride(.restricted, "9")
