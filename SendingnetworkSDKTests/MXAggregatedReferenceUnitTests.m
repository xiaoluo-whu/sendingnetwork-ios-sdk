...
- (void)testReferenceEventManually
{
    NSDictionary *messageEventDict = @{
        ...
        @"event_id": @"$messageeventid:sending.network",
        @"origin_server_ts": @(1560253386247),
        @"sender": @"@billsam:sending.network",
    ...
    NSDictionary *referenceEventDict = @{
        @"content": @{
            ...
            kMXEventRelationRelatesToKey: @{
                kMXEventContentRelatesToKeyEventId: @"$messageeventid:sending.network",
                kMXEventContentRelatesToKeyRelationType: MXEventRelationTypeReplace
            }
        },
        @"event_id": @"$replaceeventid:sending.network",
    ...
    XCTAssertEqualObjects(references.chunk.firstObject.eventId, @"$replaceeventid:sending.network");
