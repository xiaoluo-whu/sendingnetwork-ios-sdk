...
- Drop support for iOS 10 and 32-bit architectures ([#1501](https://github.com/sending-network/sendingnetwork-ios-sdk/pull/1501))
...
- Crypto: Subclass MXCrypto to enable work-in-progress Rust sdk ([#1496](https://github.com/sending-network/sendingnetwork-ios-sdk/pull/1496))
- MXBackgroundSyncService - Expose separate method for fetching a particular room's read marker event without causing extra syncs. ([#1500](https://github.com/sending-network/sendingnetwork-ios-sdk/pull/1500))
- Crypto: Integrate new Rust-based SendingnetworkSDKCrypto framework for DEBUG builds ([#1501](https://github.com/sending-network/sendingnetwork-ios-sdk/pull/1501))
...
- Fix a crash on start if the user has a very large number of unread events in a room ([#1490](https://github.com/sending-network/sendingnetwork-ios-sdk/pull/1490))
...
- Room state: Reload room state if detected empty on disk ([#1483](https://github.com/sending-network/sendingnetwork-ios-sdk/pull/1483))
...
- Crypto: Add more logs when encrypting messages ([#1476](https://github.com/sending-network/sendingnetwork-ios-sdk/pull/1476))
...
- MXTools: generateTransactionId no longer returns an optional in Swift. ([#1477](https://github.com/sending-network/sendingnetwork-ios-sdk/pull/1477))
...
- MXFileStore: Add extra logs when saving and loading room state ([#1478](https://github.com/sending-network/sendingnetwork-ios-sdk/pull/1478))
...
- Update check for server-side threads support to match spec. ([#1460](https://github.com/sending-network/sendingnetwork-ios-sdk/pull/1460))
...
- SendingnetworkSDK: Fix some crashes after 1.8.10. ([#6023](https://github.com/vector-im/element-ios/issues/6023))

Others

- Fix some warnings. ([#1440](https://github.com/sending-network/sendingnetwork-ios-sdk/pull/1440))
...
- Room data filters: strict matches support ([#1379](https://github.com/sending-network/sendingnetwork-ios-sdk/pull/1379))
...
- Add WIP to towncrier. ([#1349](https://github.com/sending-network/sendingnetwork-ios-sdk/pull/1349))
...
- MXResponse has been frozen for binary compatibility when building as an XCFramework. ([#1002](https://github.com/sending-network/sendingnetwork-ios-sdk/pull/1002))
...
- Expose missing Jingle headers in umbrella header ([#1308](https://github.com/sending-network/sendingnetwork-ios-sdk/pull/1308))
...
- Sending blank m.room.encryption on iOS will disable encryption ([Security advisory](https://github.com/sending-network/sendingnetwork-ios-sdk/security/advisories/GHSA-fxvm-7vhj-wj98))
...
- MXMemoryStore: Add missing synthesize for `areAllIdentityServerTermsAgreed`. ([#1264](https://github.com/sending-network/sendingnetwork-ios-sdk/issues/1264))
...
- Tests: Fix a crash in various tests from a missing `storeMaxUploadSize` method. ([#1175](https://github.com/sending-network/sendingnetwork-ios-sdk/issues/1175))
...
- CHANGES.md: Use towncrier to manage the change log. More info in [CONTRIBUTING](CONTRIBUTING.md#changelog). ([#1196](https://github.com/sending-network/sendingnetwork-ios-sdk/pull/1196), [#4393](https://github.com/vector-im/element-ios/issues/4393))
 ...
 * VoIP: Implement asserted identity for calls: MSC3086 (sending-network/sendingnetwork-doc/pull/3086).

🐛 Bugfix
 * MXTools: Fix bad linkification of sendingnetwork alias and URL ([#4258](https://github.com/vector-im/element-ios/issues/4258)).
 ...
 * build.sh: Add xcframework argument to build a universal SendingnetworkSDK.xcframework
 * SendingnetworkSDKTests-macOS: Remove tests from macOS profile and archive builds to match iOS.
 ...
 * MXTaggedEvents: Expose "m.tagged_events" according to [MSC2437](https://github.com/sending-network/sendingnetwork-doc/pull/2437).
 * Login flow: Add MXLoginSSOFlow to support multiple SSO Identity Providers ([MSC2858](https://github.com/sending-network/sendingnetwork-doc/pull/2858)) ([#3846](https://github.com/vector-im/element-ios/issues/3846)).
...
API Change:
 * Drop SwiftSendingnetworkSDK (vector-im/element-ios#3518).
...
## Changes in Sendingnetwork iOS SDK in 0.16.7 (2020-07-13)
================================================
...
## Changes in Sendingnetwork iOS SDK in 0.16.6 (2020-06-30)
================================================
...
## Changes in Sendingnetwork iOS SDK in 0.16.5 (2020-05-18)
================================================

Improvements:
 * MXSession: Update account data as soon as the endpoint returns.
 * MXSecretStorage: Add this class to support SSSS ([MSC1946(]https://github.com/sending-network/sendingnetwork-doc/pull/1946).
 * SAS verification: Support new key agreement.
 * SendingnetworkSDK/JingleCallStack: Update Jitsi Meet dependency to ~> 2.8.1 and upgrade the minimal iOS version to 11.0 because the Jitsi Meet framework requires it.
...
## Changes in Sendingnetwork iOS SDK in 0.16.4 (2020-05-07)
================================================
...
## Changes in Sendingnetwork iOS SDK in 0.16.3 (2020-05-07)
================================================
...
## Changes in Sendingnetwork iOS SDK in 0.16.2 (2020-04-30)
================================================
...
## Changes in Sendingnetwork iOS SDK in 0.16.1 (2020-04-24)
================================================
...
## Changes in Sendingnetwork iOS SDK in 0.16.0 (2020-04-17)
================================================
 ...
 * MXCrypto: Restart broken Olm sessions ([MSC1719](https://github.com/sending-network/sendingnetwork-doc/pull/1719)) (vector-im/riot-ios/issues/2129).
 ...
 * Aggregations: Implement m.reference aggregations, aka thread ([MSC1849](https://github.com/sending-network/sendingnetwork-doc/blob/matthew/msc1849/proposals/1849-aggregations.md)).
...
## Changes in Sendingnetwork iOS SDK in 0.15.2 (2019-12-05)
===============================================
...
## Changes in Sendingnetwork iOS SDK in 0.15.1 (2019-12-04)
===============================================

Improvements:
 * Well-known: Expose "m.integrations" according to [MSC1957](https://github.com/sending-network/sendingnetwork-doc/pull/1957) (vector-im/riot-ios#2815).
 * MXSession: Expose and store homeserverWellknown.
 * SwiftSendingnetworkSDK: Add missing start(withSyncFilter:) refinement to MXSession.swift.
 
Bug fix:
 * MXIdentityServerRestClient: Match registration endpoint to the IS r0.3.0 spec (vector-im/riot-ios#2824).

## Changes in Sendingnetwork iOS SDK in 0.15.0 (2019-11-06)
===============================================
...
## Changes in Sendingnetwork iOS SDK in 0.14.0 (2019-10-11)
===============================================
 ...
 * MXRestClient: Add new APIs from MSC2290 (sending-network/sendingnetwork-doc/pull/2290).
 ...
 * MXSendingnetworkVersions: Add doesServerRequireIdentityServerParam and doesServerAcceptIdentityAccessToken properties.
 * MXSendingnetworkVersions: Support r0.6.0. Add doesServerSupportSeparateAddAndBind (vector-im/riot-ios#2718).
 ...
 * Privacy: Store Identity Server in Account Data ([MSC2230](https://github.com/sending-network/sendingnetwork-doc/pull/2230))(vector-im/riot-ios#2665).
 ...
 * Privacy: Sending Third-Party Request Tokens via the Homeserver ([MSC2078](https://github.com/sending-network/sendingnetwork-doc/pull/2078)).
...
## Changes in Sendingnetwork iOS SDK in 0.13.1 (2019-08-08)
===============================================
...
## Changes in Sendingnetwork iOS SDK in 0.13.0 (2019-07-16)
===============================================
 ...
 * MXHTTPClient: Add a new notification name `kMXHTTPClientSendingnetworkErrorNotification` posted on each Sendingnetwork error.
 ...
 * Aggregations: Create MXSession.MXAggregations to manage Sendingnetwork aggregations API.
 * Add the Sendingnetwork errors related to the password policy.
 * SwiftSendingnetworkSDK: Migrate to Swift 5.0.
...
## Changes in Sendingnetwork iOS SDK in 0.12.5 (2019-05-03)
===============================================
...
## Changes in Sendingnetwork iOS SDK in 0.12.4 (2019-03-21)
===============================================

Bug Fix:
 * MXRestClient: Fix file upload with filename containing whitespace (PR #645).

## Changes in Sendingnetwork iOS SDK in 0.12.3 (2019-03-08)
===============================================
...
## Changes in Sendingnetwork iOS SDK in 0.12.2 (2019-02-15)
===============================================
...
## Changes in Sendingnetwork iOS SDK in 0.12.1 (2019-01-04)
===============================================
...
## Changes in Sendingnetwork iOS SDK in 0.12.0 (2018-12-06)
===============================================
 ...
 * MXMediaManager: Add a constructor based on a homeserver URL, to handle directly the Sendingnetwork Content URI (mxc://...).
 * MXSession: Add a MediaManager instance to handle the media stored on the Sendingnetwork Content repository.
 * MXMediaManager: Support the media download from a Sendingnetwork Content Scanner (Antivirus Server).
 * MXJSONModels: Add data models for Terms of service / privacy policy API (https://github.com/sending-network/sendingnetwork-doc/blob/travis/msc/terms-api/proposals/1692-terms-api.md).
...
API break:
 * MXMediaManager: [downloadMediaFromURL:andSaveAtFilePath:success:failure:] is removed, use [downloadMediaFromSendingnetworkContentURI:withType:inFolder:success:failure] or [downloadThumbnailFromSendingnetworkContentURI:withType:inFolder:toFitViewSize:withMethod:success:failure] instead.
 * MXMediaManager: [downloadMediaFromURL:andSaveAtFilePath:] is removed, use [downloadMediaFromSendingnetworkContentURI:withType:inFolder:] instead.
 * MXMediaManager: [existingDownloaderWithOutputFilePath:] is removed, use [existingDownloaderWithIdentifier:] instead.
 * MXMediaManager: [cachePathForMediaWithURL:andType:inFolder:] is removed, use [cachePathForSendingnetworkContentURI:andType:inFolder:] instead.
 ...
 * The Sendingnetwork Content repository contants are moved to MXEnumConstants.h
 * [urlOfIdenticon:] is moved from MXRestClient to MXMediaManager.

## Changes in Sendingnetwork iOS SDK in 0.11.6 (2018-10-31)
===============================================
 ...
 * MXRestClient: Handle GET /_api/client/r0/profile/{userId} request.
...
## Changes in Sendingnetwork iOS SDK in 0.11.5 (2018-10-05)
===============================================
...
## Changes in Sendingnetwork iOS SDK in 0.11.4 (2018-09-26)
===============================================
...
## Changes in Sendingnetwork iOS SDK in 0.11.3 (2018-08-27)
===============================================

Bug fix:
 * MXJSONModel: Manage `m.server_notice` empty tag sent due to a bug server side (PR #556).

## Changes in Sendingnetwork iOS SDK in 0.11.2 (2018-08-24)
===============================================

Improvements:
 * MXSession: Add the supportedSendingnetworkVersions method getting versions of the specification supported by the homeserver.
 ...
 * MXError: Define constant strings for keys and values that can be found in a Sendingnetwork JSON dictionary error.
...
## Changes in Sendingnetwork iOS SDK in 0.11.1 (2018-08-17)
===============================================
...
## Changes in Sendingnetwork iOS SDK in 0.11.0 (2018-08-10)
===============================================

Improvements:
 * MXSession: Add the option to use a Sendingnetwork filter in /sync requests ([MXSession startWithSyncFilter:]).
 * MXSession: Add API to manage Sendingnetwork filters.
 * MXRestClient: Add Sendingnetwork filter API.
...
## Changes in Sendingnetwork iOS SDK in 0.10.12 (2018-05-31)
=============================================== 

Improvements:
 * MXCrypto: Add reRequestRoomKeyForEvent to re-request encryption keys to decrypt an event (vector-im/riot-ios/issues/1879).
 * Sendingnetwork filters: Create or update models for them: MXFilter, MXRoomFilter & MXRoomEventFilter.
...
## Changes in Sendingnetwork iOS SDK in 0.10.11 (2018-05-31)
=============================================== 
...
## Changes in Sendingnetwork iOS SDK in 0.10.10 (2018-05-23)
=============================================== 
...
## Changes in Sendingnetwork iOS SDK in 0.10.9 (2018-04-23)
=============================================== 

Bug fixes:
 * Regression: Sending a photo from the photo library causes a crash.

## Changes in Sendingnetwork iOS SDK in 0.10.8 (2018-04-20)
=============================================== 
...
Bug fixes:
 * SendingnetworkSDK/JingleCallStack: Upgrade the minimal iOS version to 9.0 because the WebRTC framework requires it (vector-im/riot-ios#1821).
 * App fails to logout on unknown token (vector-im/riot-ios#1839).
 * All rooms showing the same avatar (vector-im/riot-ios#1673).

## Changes in Sendingnetwork iOS SDK in 0.10.7 (2018-03-30)
=============================================== 
...
## Changes in Sendingnetwork iOS SDK in 0.10.6 (2018-03-12)
=============================================== 

Improvements:
 * SwiftSendingnetworkSDK is now compatible with Swift 4, thanks to @johnflanagan-spok (PR #463).
 * Crypto: Make sure we request keys for only valid sendingnetwork user ids.
 * MXRoom: We should retry messages with same txn id when hitting 'resend' (vector-im/riot-ios#1731).
 * MXTools: Make isSendingnetworkUserIdentifier support historical user ids (vector-im/riot-ios#1743).
 ...
 * MXTools: Fix the regex part for the HS domain part in all isSendingnetworkXxxxIdentifier methods.
 ...
 * MXRestClient: Add a txnId parameter to the sendEventToRoom method to better follow the sendingnetwork spec.
 
## Changes in Sendingnetwork iOS SDK in 0.10.5 (2018-02-09)
=============================================== 
 ...
 * MXSession - Groups Flair: Handle the publicised groups for the sendingnetwork users (vector-im/riot-meta#118).
 ...
 * MXTools - Groups: add `isSendingnetworkGroupIdentifier` method.
 * Bumped SwiftSendingnetworkSDK.podspec dependency to GZIP 1.2.1, thanks to @nrakochy.
 * MXSDKOptions: Remove enableGoogleAnalytics. It is no more used (PR #448).
 * Crypto: The crypto is now built by default in sendingnetwork-ios-sdk (PR #449).
...
## Changes in Sendingnetwork iOS SDK in 0.10.4 (2017-11-30)
=============================================== 
...
## Changes in Sendingnetwork iOS SDK in 0.10.3 (2017-11-13)
=============================================== 

Bug fixes:
 * A 1:1 invite is not displayed as a direct chat after clearing the cache.

## Changes in Sendingnetwork iOS SDK in 0.10.1 (2017-10-27)
===============================================
...
## Changes in Sendingnetwork iOS SDK in 0.10.0 (2017-10-23)
===============================================
...
## Changes in Sendingnetwork iOS SDK in 0.9.3 (2017-10-03)
===============================================
...
## Changes in Sendingnetwork iOS SDK in 0.9.2 (2017-08-25)
===============================================
...
## Changes in Sendingnetwork iOS SDK in 0.9.1 (2017-08-08)
===============================================
 ...
 * App crashed I don't know why, suspect memory issues / Crash in [MXRoomState copyWithZone:] (https://github.com/sending-network/riot-ios-rageshakes#132).

API breaks:
 * Replace [MXRoomState stateEventWithType:] by [MXRoomState stateEventsWithType:].

## Changes in Sendingnetwork iOS SDK in 0.9.0 (2017-08-01)
===============================================
 ...
 * Crypto: Fix crash when encountering a badly formatted olm message (https://github.comsending-network/riot-ios-rageshakes#107).
...
## Changes in Sendingnetwork iOS SDK in 0.8.2 (2017-06-30)
===============================================

Improvements:
 * MXFileStore: Improve performance by ~5% (PR #318).

## Changes in Sendingnetwork iOS SDK in 0.8.1 (2017-06-23)
===============================================
...
## Changes in Sendingnetwork iOS SDK in 0.8.0 (2017-06-16)
===============================================

Improvements:
 * The minimal iOS version is now 8.0, 10.10 for macOS.
 * Add read markers synchronisation across sendingnetwork clients.
 ...
 * Extract background mode handling outside of Sendingnetwork SDK, thanks to Samuel Gallet (PR #296).
 ...
 * Crypto: Rework device list tracking logic in to order to fix UISI (https://github.com/sending-network/sendingnetwork-js-sdk/pull/425 & https://github.com/sending-network/sendingnetwork-js-sdk/pull/431).
...
## Changes in Sendingnetwork iOS SDK in 0.7.11 (2017-03-23)
===============================================
...
## Changes in Sendingnetwork iOS SDK in 0.7.10 (2017-03-21)
===============================================

Bug fix:
 * Registration with email failed when the email address is validated on the mobile phone.

## Changes in Sendingnetwork iOS SDK in 0.7.9 (2017-03-16)
===============================================
...
## Changes in Sendingnetwork iOS SDK in 0.7.8 (2017-03-07)
===============================================
...
## Changes in Sendingnetwork iOS SDK in 0.7.7 (2017-02-08)
===============================================
...
## Changes in Sendingnetwork iOS SDK in 0.7.6 (2017-01-24)
===============================================
...
## Changes in Sendingnetwork iOS SDK in 0.7.5 (2017-01-19)
===============================================

Improvements:
 * Sendingnetwork iOS SDK in now compatible with macOS, thanks to @aapierce0 (PR #218).
...
## Changes in Sendingnetwork iOS SDK in 0.7.4 (2016-12-23)
===============================================
...
## Changes in Sendingnetwork iOS SDK in 0.7.3 (2016-11-23)
===============================================
...
## Changes in Sendingnetwork iOS SDK in 0.7.2 (2016-11-22)
===============================================
...
## Changes in Sendingnetwork iOS SDK in 0.7.1 (2016-11-18)
===============================================
...
## Changes in Sendingnetwork iOS SDK in 0.7.0 (2016-11-16)
===============================================
...
## Changes in Sendingnetwork iOS SDK in 0.6.17 (2016-09-27)
================================================
...
## Changes in Sendingnetwork iOS SDK in 0.6.16 (2016-09-15)
================================================
...
## Changes in Sendingnetwork iOS SDK in 0.6.15 (2016-09-14)
================================================
...
## Changes in Sendingnetwork iOS SDK in 0.6.14 (2016-09-08)
================================================
 ...
 * MXTools: Add [MXTools isSendingnetworkEventIdentifier:].
...
## Changes in Sendingnetwork iOS SDK in 0.6.13 (2016-08-25)
================================================
 ...
 * MXSession & MXRestClient: Add createRoom with a parameters dictionary to manage all fields available in Sendingnetwork spec.
...
## Changes in Sendingnetwork iOS SDK in 0.6.12 (2016-08-01)
================================================
...
## Changes in Sendingnetwork iOS SDK in 0.6.11 (2016-07-26)
================================================
...
## Changes in Sendingnetwork iOS SDK in 0.6.10 (2016-07-15)
================================================
...
## Changes in Sendingnetwork iOS SDK in 0.6.9 (2016-07-01)
===============================================
 ...
 * MXTools: Add isSendingnetworkRoomAlias, isSendingnetworkRoomIdentifier and isSendingnetworkUserIdentifier methods.
...
## Changes in Sendingnetwork iOS SDK in 0.6.8 (2016-06-01)
===============================================
...
## Changes in Sendingnetwork iOS SDK in 0.6.7 (2016-05-04)
===============================================
...
## Changes in Sendingnetwork iOS SDK in 0.6.6 (2016-04-26)
===============================================
...
## Changes in Sendingnetwork iOS SDK in 0.6.5 (2016-04-08)
===============================================
...
## Changes in Sendingnetwork iOS SDK in 0.6.4 (2016-03-17)
===============================================
...
## Changes in Sendingnetwork iOS SDK in 0.6.3 (2016-03-07)
===============================================
...
## Changes in Sendingnetwork iOS SDK in 0.6.2 (2016-02-09)
===============================================
...
## Changes in Sendingnetwork iOS SDK in 0.6.1 (2016-01-29)
===============================================
...
## Changes in Sendingnetwork iOS SDK in 0.6.0 (2016-01-22)
===============================================
...
## Changes in Sendingnetwork iOS SDK in 0.5.7 (2015-11-30)
===============================================
...
## Changes in Sendingnetwork iOS SDK in 0.5.6 (2015-11-13)
===============================================
...
## Changes in Sendingnetwork iOS SDK in 0.5.5 (2015-11-12)
===============================================
...
## Changes in Sendingnetwork iOS SDK in 0.5.4 (2015-11-06)
===============================================
...
## Changes in Sendingnetwork iOS SDK in 0.5.3 (2015-09-14)
===============================================
...
## Changes in Sendingnetwork iOS SDK in 0.5.2 (2015-08-13)
===============================================

Improvements:
 * Fixed code that made Cocoapods 0.38.2 unhappy.

## Changes in Sendingnetwork iOS SDK in 0.5.1 (2015-08-10)
===============================================
...
## Changes in Sendingnetwork iOS SDK in 0.5.0 (2015-07-10)
===============================================
...
## Changes in Sendingnetwork iOS SDK in 0.4.0 (2015-04-23)
===============================================
 ...
 * MXSession/MXRoom: return a MXHTTPOperation for all methods taht make HTTP
   requests to the Sendingnetwork Client-Server API so that the SDK client can cancel
   them.
...
-----------------
 Sendingnetwork Console
-----------------
Console source code has been moved into its own git repository:
https://github.com/sending-network/sendingnetwork-ios-console.


## Changes in Sendingnetwork iOS SDK in 0.3.2 (2015-03-27)
===============================================
 ...
 * Improved image rotation support over different Sendingnetwork clients.
...
## Changes in Sendingnetwork iOS SDK in 0.3.1 (2015-03-03)
===============================================
 ...
 * MXSession: Slightly randomise reconnection times by up to 3s to prevent all
   Sendingnetwork clients from retrying requests to the homeserver at the same time.
 * Improved logs
...
## Changes in Sendingnetwork iOS SDK in 0.3.0 (2015-02-23)
===============================================
...
-----
Breaks:
 * [MXSession initWithSendingnetworkRestClient: andStore: ] and the onStoreDataReady
...
## Changes in Sendingnetwork iOS SDK in 0.2.2 (2015-02-05)
===============================================
 ...
 * SYIOS-54 - Sendingnetwork Console app slightly freezes when receiving a message
...
-----------------
Improvements:
 * When long pressing on a message, the app shows the JSON string of the Sendingnetwork
   event.
...
Features:
 * Push notifications.
 * Added a contacts screen that displays Sendingnetwork users the user had interactions
   with and contacts from the device phonebook.
 * Contacts from the device phonebook who have an email linked to a Sendingnetwork user
...
## Changes in Sendingnetwork iOS SDK in 0.2.1 (2015-01-14)
===============================================
 ...
 * MXRESTClient provides helpers to resolve Sendingnetwork Content URI ("mxc://...")
   and their thumbnail.
 
Bug fixes:
 * Fixed 1:1 room renaming
 * SYIOS-37 - When restarting Sendingnetwork Console from the cache, users presences
   are lost
...
## Changes in Sendingnetwork iOS SDK in 0.2.0 (2014-12-19)
===============================================
...
-----
Improvements:
 * The SDK is now available on CocoaPods ($ pod search SendingnetworkSDK)
 * Updated [MXRestClient joinRoom] to support both room id and room alias.
 * SDK tests: Improved tests suite duration.
 * The SDK version is available with SendingnetworkSDKVersion
 
Features:
 * Added MXFileStore, a MXStore implementation to store Sendingnetwork events
...
Features:
 * Use new Sendingnetwork content repository to generate thumbnails and store contents.
...
## Changes in Sendingnetwork iOS SDK in 0.1.0 (2014-12-09)
===============================================
